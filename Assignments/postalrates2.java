 ...
 */
 ...
 class postalrates2{//open class
     public static void main(String[]args){//open main
        ...
        while (!uI.hasNextInt()){
        System.out.print("Invalid entry. How many letters would you like? ");
         uI.next();
        }
        ...
        letters = uI.nextInt();
         ...
         System.out.printf("The cost per letter is $%d. The total cost is $%d.", costperletter, totalcost);
     }// close main 
}//close class