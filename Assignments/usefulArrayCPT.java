 ...
 */
 ...
 class usefulArrayCPT {//open Main
     ...
     private static int itemsCollected, randnum, itemsObtained, BossChoice, userChoice = 0, bossScore = 0, playerScore = 0, userguess = 0, rounds = 0, lives = 5, difference = 0;
